...
/// <summary>
/// A middleware for injecting OWASP recommended headers into a HTTP Request
/// </summary>
public class SecureHeadersMiddleware
{
    ...
    /// <summary>
    /// The main task of the middleware. This will be invoked whenever the middleware fires
    /// </summary>
    ...
    public async Task Invoke(HttpContext httpContext)
    {
        ...
        if (_config.UseFeaturePolicy)
        {
            httpContext.TryAddHeader(Constants.FeaturePolicyHeaderName,
                _config.FeaturePolicy.BuildHeaderValue());

            httpContext.TryAddHeader(Constants.PermissionsPolicyHeaderName,
                _config.FeaturePolicy.BuildHeaderValue());
        }
